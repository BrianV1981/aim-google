...
notes_file="$(mktemp -t aim-google-release-notes)"
awk -v ver="$version" '
...
formula_path="../homebrew-tap/Formula/aim-google.rb"
...
tmp_assets_dir="$(mktemp -d -t aim-google-release-assets)"
...
darwin_amd64_expected="$(sha_for_asset "aim-google_${version}_darwin_amd64.tar.gz")"
darwin_arm64_expected="$(sha_for_asset "aim-google_${version}_darwin_arm64.tar.gz")"
linux_amd64_expected="$(sha_for_asset "aim-google_${version}_linux_amd64.tar.gz")"
linux_arm64_expected="$(sha_for_asset "aim-google_${version}_linux_arm64.tar.gz")"

darwin_amd64_formula="$(formula_sha_for_url "aim-google_#{version}_darwin_amd64.tar.gz")"
darwin_arm64_formula="$(formula_sha_for_url "aim-google_#{version}_darwin_arm64.tar.gz")"
linux_amd64_formula="$(formula_sha_for_url "aim-google_#{version}_linux_amd64.tar.gz")"
linux_arm64_formula="$(formula_sha_for_url "aim-google_#{version}_linux_arm64.tar.gz")"
...
brew upgrade aim-google || brew install BrianV1981/tap/aim-google
